...
const TemplateGeneratorLayout: React.FC = () => {
	...
	const [message, setMessageType] = useState<any>(null)
	...
	async function generateTemplate(choice: string): Promise<any> {
		try {
			...
			setMessageType(JSON.parse(birthdayGreeting || "{}"))
	...
	async function handleSubmit(e: React.FormEvent) {
		...
		const textMessagesObj: any = await generateTemplate(templateType)
		setMessageType(textMessagesObj)
